    ...
    d.append(
        {
            ...
            "Average age": data[data["cluster", "cluster"] == i][
                "STATS", "Average Age"
            ].mean(),
            "Average age count": data[data["cluster", "cluster"] == i][
                "STATS", "Average Age"
            ].count(),
        }
    )
...
for i in range(0, int(data["cluster", "cluster"].max())):
    d.append(
        {
            "Building year": data[data["cluster", "cluster"] == i][
                "STATS", "Building year"
            ].mean(),
            "Building year count": data[data["cluster", "cluster"] == i][
                "STATS", "Building year"
            ].count(),
            "Apartment no. mean": data[data["cluster", "cluster"] == i][
                "STATS", "Apartment no"
            ].mean(),
            "Apartment no. count": data[data["cluster", "cluster"] == i][
                "STATS", "Apartment no"
            ].count(),
        }
    )
...
data["STATS", "Rented for residential purposes"] = (
...
for i in range(0, int(data["cluster", "cluster"].max())):
    d.append(
        {
            "Rented for residential purposes": data[data["cluster", "cluster"] == i][
                "STATS", "Rented for residential purposes"
            ].mean(),
            "Rented for residential purposes count": data[
                data["cluster", "cluster"] == i
            ]["STATS", "Rented for residential purposes"].count(),
            "Holiday apartment": data[data["cluster", "cluster"] == i][
                "STATS", "Holiday apartment"
            ].mean(),
            "Holiday apartment count": data[data["cluster", "cluster"] == i][
                "STATS", "Holiday apartment"
            ].count(),
            "Average floor space": data[data["cluster", "cluster"] == i][
                "STATS", "Average floor space"
            ].mean(),
            "Average floor space count": data[data["cluster", "cluster"] == i][
                "STATS", "Average floor space"
            ].count(),
        }
    )
...
data["STATS", "Average family size"] = (
...
for i in range(0, int(data["cluster", "cluster"].max())):
    d.append(
        {
            "Average family size": data[data["cluster", "cluster"] == i][
                "STATS", "Average family size"
            ].mean(),
            "Average family size count": data[data["cluster", "cluster"] == i][
                "STATS", "Average family size"
            ].count(),
        }
    )
