...
translations = pd.read_excel('Notebooks/Data_Format_Census.xlsx', sheet_name='Translations')
...
for i in paths:
    ...
    if i in ['Zensus_Bevoelkerung_100m-Gitter.csv','Bevoelkerung100M.csv']:
        data = pd.read_csv("/Users/lisawinkler/Documents/PhD/Data/Germany_Census_2011/" + i, 
    ...
    data.to_parquet(i[:-4] + '_processed.parquet')
